...
const featureIcons = [
	<FolderPlus key="folder" className="w-8 h-8 text-blue-600" />,
	<Upload key="upload" className="w-8 h-8 text-purple-600" />,
	<Brain key="brain" className="w-8 h-8 text-green-600" />
];
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            {features.map((feature: IFeature, index: number) => (
              <div key={index} className="relative">
                ...
                {/* Feature Card */}
                <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 h-full relative overflow-hidden">
                  {/* Background Pattern */}
