    ...
    <MotionSection>
      <div className={"flex bg-emerald-500 rounded-3xl md:flex-row flex-col max-w-6xl mx-auto"}>
          <div className="flex-2 p-4 md:p-8 flex flex-col items-center md:items-start">
              ...
              <Button className="bg-white text-emerald-500 rounded-xl font-bold text-xl mt-4 w-fit p-6 hover:bg-gray-200 focus:scale-98 transition-all duration-300">Join Us</Button>
          </div>
